...
To check the transfered image, just go to the registry console on IBM Cloud and click on the repositories tab:

image:../images/ibm-image-repository-check-image.png[Check Image Repository ad IBM Cloud]
